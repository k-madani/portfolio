  ...
  return (
    <section className="relative min-h-[90vh] md:min-h-screen flex items-center justify-center px-6 sm:px-8 overflow-hidden pt-24 sm:pt-28 lg:pt-32 pb-16 sm:pb-20">
          ...
          >
            ...
            <div className="h-10 sm:h-12 md:h-14 lg:h-16 mb-3 sm:mb-4 overflow-hidden">
              <motion.div
                ...
                className="text-lg sm:text-2xl md:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-[rgb(var(--accent-primary))] via-[rgb(var(--accent-light))] to-[rgb(var(--accent-primary))] bg-clip-text text-transparent leading-tight"
              >
                {roles[currentRole]}
              </motion.div>
            </div>
            ...
            >
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 text-sm sm:text-base bg-gradient-to-r from-[rgb(var(--accent-primary))] to-[rgb(var(--accent-light))] text-white font-semibold hover:shadow-2xl hover:shadow-[rgb(var(--accent-primary))]/30 transition-all duration-300"
              >
                Resume
              </motion.a>
              <motion.a
                ...
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-5 sm:px-6 md:px-8 py-2.5 sm:py-3 text-sm sm:text-base border-2 border-[rgb(var(--accent-primary))] text-[rgb(var(--accent-primary))] font-semibold hover:bg-[rgb(var(--accent-primary))]/5 transition-all duration-300"
              >
                Get in Touch
              </motion.a>
            </motion.div>
      ...
      <motion.button
        ...
        className="absolute bottom-6 sm:bottom-8 left-1/2 -translate-x-1/2 cursor-pointer group hidden sm:block"
      ...
      <div className="absolute inset-0 -z-10 overflow-hidden pointer-events-none">
        <div className="absolute top-1/4 -right-32 sm:-right-48 w-64 sm:w-96 h-64 sm:h-96 bg-[rgb(var(--accent-primary))]/5 rounded-full blur-3xl" />
        <div className="absolute bottom-1/4 -left-32 sm:-left-48 w-64 sm:w-96 h-64 sm:h-96 bg-[rgb(var(--accent-light))]/5 rounded-full blur-3xl" />
      </div>
    </section>
  );
}